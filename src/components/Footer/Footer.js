    ...
    return (
        <div className="footer">
            <div className="row footer-style">
                {/* Column 1 */}
                <div className="col-3">
                    <h5 style={{ color: 'white', fontFamily: 'Times New Roman, Times, serif', marginBottom: '15px' }}>Company</h5><hr />
                ...
                {/* Column 2 */}
                <div className="col-3">
                    <h5 style={{ color: 'white', fontFamily: 'Times New Roman, Times, serif', marginBottom: '15px' }}>View Website in</h5><hr />
                ...
                {/* Column 3 */}
                <div className="col-3">
                    <h5 style={{ color: 'white', fontFamily: 'Times New Roman, Times, serif', marginBottom: '15px' }}>Need help?</h5><hr />
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-check2-all" viewBox="0 0 16 16">
                        <path d="..." />
                    </svg>
                ...
                {/* Column 4 */}
                <div className="col-3">
                    <h5 style={{ color: 'white', fontFamily: 'Times New Roman, Times, serif', marginBottom: '15px' }}>Connect with us</h5><hr />
                    ...
                    <p style={{ marginTop: '10px' }}>Follow us for more information</p>
                </div>
            </div>
